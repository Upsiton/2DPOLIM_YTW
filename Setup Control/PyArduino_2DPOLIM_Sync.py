...
# NOTICE: some code here is copy from the GUI code, in which some function or variables are defined for tkinter and not applicable here. e.g. entry1_nscan.delete... setArduinoConfig()
...
######### Some cmd of laser:
open_flag = laser488_Serial.is_open # Check open state. Returns bool
...
#########
PyLaserCMD("p 0.01056")
#RTN: Send command to laser: p 0.01056
#RTN: Laser returns: OK
#RTN: Out[12]: 'OK'

PyLaserCMD("p?") # Re:Float (W)
#RTN: Send command to laser: p?
#RTN: Laser returns: 0.0106
#RTN: Out[13]: '0.0106'

PyLaserCMD("pa?") # Re:Float (W)
#RTN: Send command to laser: pa?
#RTN: Laser returns: 0.0106
#RTN: Out[14]: '0.0106'
